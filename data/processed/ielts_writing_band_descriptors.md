...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 9 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 8 could not be identified reliably from the PDF text layer; wording is preserved.]
...
- (General Training) All bullet points are covered and clearly highlighted but could be more fully or more appropriately illustrated or extended.
- It presents a clear purpose.
- The tone is consistent and appropriate to the task.
- Any lapses are minimal.

#### Coherence and Cohesion

- Information and ideas are logically organised and there is a clear progression throughout the response.
- A few lapses may occur.
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 7 could not be identified reliably from the PDF text layer; wording is preserved.]
...
- (Academic) Key features which are selected are covered and adequately highlighted.
- A relevant overview is attempted.
- Information is appropriately selected and supported using figures/data.
- (General Training) All bullet points are covered and adequately highlighted.
- The purpose is generally clear.
- There may be minor inconsistencies in tone.
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 6 could not be identified reliably from the PDF text layer; wording is preserved.]
...
- The purpose may be unclear at times.
- The tone may be variable and sometimes inappropriate.
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 5 could not be identified reliably from the PDF text layer; wording is preserved.]
...
- The resource is limited and inadequate for or unrelated to the task.
- Vocabulary is basic and may be used repetitively.
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 4 could not be identified reliably from the PDF text layer; wording is preserved.]
...
- Minimal use of sequencers or cohesive devices.
...
- Sentence forms are attempted, but errors in grammar and punctuation predominate (except in memorised phrases or those taken from the input material).
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 3 could not be identified reliably from the PDF text layer; wording is preserved.]
...
- the entire response may be off-topic.
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 2 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 1, Band 1 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 9 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 8 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 7 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 6 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 5 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 4 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 3 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 2 could not be identified reliably from the PDF text layer; wording is preserved.]
...
[FORMATTING_NEEDS_REVIEW: Bold emphasis in the source table for Writing Task 2, Band 1 could not be identified reliably from the PDF text layer; wording is preserved.]
